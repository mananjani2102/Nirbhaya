    ...
    <div className="h-screen w-full bg-surface text-on-surface font-body antialiased flex overflow-hidden relative">
      ...
      <div className="w-full lg:w-1/2 h-full flex flex-col justify-center items-center relative bg-white">
        ...
        <div className="lg:hidden absolute top-0 left-0 w-full p-6 flex justify-between items-center bg-white/80 backdrop-blur-md">
          <h1 className="font-headline text-2xl font-bold text-primary tracking-tight">Nirbhaya</h1>
        </div>

        <div className="w-full max-w-[420px] bg-white rounded-[24px] p-10 relative z-10" style={{ boxShadow: "0 10px 40px -10px rgba(141, 157, 79, 0.12)" }}>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <button
              className="w-full mt-2 h-[52px] bg-primary text-white font-headline font-semibold text-lg rounded-xl transition-all hover:bg-primary/90 active:scale-[0.98] flex justify-center items-center shadow-lg shadow-primary/20 disabled:opacity-50 disabled:cursor-not-allowed"
              type="submit"
              disabled={isLoading}
            >
      ...
      <div className="hidden lg:flex w-1/2 relative flex-col overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#2c2a1e]/90 via-[#2c2a1e]/40 to-transparent"></div>
          <div className="absolute inset-0 bg-gradient-to-r from-[#2c2a1e]/30 to-transparent"></div>
        </div>

        <div className="relative z-10 h-full flex flex-col p-12 justify-start">
          <div className="flex items-center gap-4 mb-32">
            <h1 className="font-headline text-3xl font-bold text-white tracking-tight">Nirbhaya</h1>
          ...
          <div className="bg-white/10 backdrop-blur-[20px] p-6 rounded-2xl border border-white/20 max-w-sm ml-auto shadow-2xl">
            <div className="flex gap-0.5 text-[#d9cfb0] mb-3">
